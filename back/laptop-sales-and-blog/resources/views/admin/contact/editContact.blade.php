...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.updateContact', $contact->id) }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="phone" id="phone"
                                ...
                                placeholder="Office phone number" value="{{ old('phone', $contact->phone) }}" required>
                            @error('phone')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email" placeholder="Office email"
                                value="{{ old('email', $contact->email) }}" class="form-control mt-2 @error('email') is-invalid @enderror"
                                required>
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" id="address" placeholder="Office location"
                                class="form-control mt-2 @error('address') is-invalid @enderror" required>{{ old('address', $contact->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" id="open_time" name="open_time" value="{{ old('open_time', $contact->open_time) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" id="close_time" name="close_time" value="{{ old('close_time', $contact->close_time) }}"
                    ...
                    <div class="col-md-6">
                        <!-- Map Picker Start -->
                        <input type="hidden" name="coordinates" value="{{ old('coordinates', $coordinates) }}" class="example"/>
                        <div id="mapContainer" class="w-100" style="height: 400px"></div>
                        <!-- Map Picker End -->
                        <a href="{{ route('admin.contact') }}" class="btn btn-secondary mt-2">Cancel</a>
                        <button type="submit" class="btn btn-info text-light mt-2"><i class="fa-solid fa-up-long me-1"></i>Update</button>
                    </div>
                </div>
            </form>
        </div>
